...
byte startHour = 14;    // Set our start and end times
byte startMinute = 27;  // Don't add leading zero to hour or minute - 7, not 07
byte endHour = 14;      // Use 24h format for the hour, without leading zero
byte endMinute = 28;
