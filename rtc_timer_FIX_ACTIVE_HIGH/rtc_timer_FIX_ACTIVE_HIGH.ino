...
int ledPin = 3;         // Set our LED pin

byte startHour = 9;    // Set our start and end times
byte startMinute = 31;  // Don't add leading zero to hour or minute - 7, not 07
byte endHour = 9;      // Use 24h format for the hour, without leading zero
byte endMinute = 31;
