...
void hazard () {
          while(switchCharacteristic7.value()==49){
          ...
          delay(500);
          if (switchCharacteristic7.value()!=49){
            exit;
            }
          }
  }
  ...
  void flashleft () {
          while(switchCharacteristic5.value()==49){
          digitalWrite(ledPin5, HIGH);
          delay(500);
          digitalWrite(ledPin5, LOW);
          delay(500);
          if (switchCharacteristic5.value()!=49){
            exit;
            }
          }
  }
...
void flashright () {
          while(switchCharacteristic6.value()==49){
          digitalWrite(ledPin6, HIGH);            // will turn the LED on
          delay(500);
          digitalWrite(ledPin6, LOW);
          delay(500);
          if (switchCharacteristic6.value()!=49){
            exit;
            }
          }
  }
  ...
  if (central) {
   ...
   if (switchCharacteristic2.written()) 
      ...
      if (switchCharacteristic5.value()==49) {  // any value other than 0
          ...
          flashleft ();            // will turn the LED on
      ...
      if (switchCharacteristic6.value()==49) {  // any value other than 0
          ...
          flashright();          // will turn the LED on
