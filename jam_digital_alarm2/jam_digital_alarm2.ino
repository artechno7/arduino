  ...
  lcd.clear();
    ...
    while(1){
     ...
     if (myBtn.wasReleased())  {b++; if(b==7) b=1;}
      ...
      break;
      case 3:
      lcd.setCursor(0,1);lcd.print(tanggal,DEC);
      lcd.setCursor(0,1);lcd.print("  ");
      lcd.setCursor(2,1);lcd.print("-");
...
void Set_alrm(){
 ...
 while(1){
  ...
  if(state_alrm==1) {lcd.setCursor(7,0);lcd.print("OFF");}
  if(state_alrm==2) {lcd.setCursor(7,0);lcd.print("ON ");}
